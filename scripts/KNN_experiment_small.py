...
if __name__ == '__main__':
    ...
    if args.metric == 'fractional':
        logging.info(f'Skip KNeighborsRegressor for fractional distance')
        ...
        print('KNN: ',evaluate_metrics(y_true,predictions,scorer=scorer,y_metadata=y_metadata))
    
    ### Run sklearn.linear_model.LinearRegression()
    ...
    print('Linear: ',evaluate_metrics(y_true,predictions,scorer=scorer,y_metadata=y_metadata))
    ...
    ### Evaluate prediction and true phenotype of test_dataset
    print('bigKNN: ',model.evaluate_metrics())
