...
if __name__ == '__main__':
    ...
    for i,split in enumerate(split_lys):
        ...
        output_filename = f'pca_intermediates_{N_SPLITS}FoldCV_random_state_{RANDOM_STATE}_split_{i}_{args.dataset}_device_{args.device}_batchsize_{args.batch_size}.hdf5'
