...
if __name__ == '__main__':
    ...
    filename = f'NEW_KNN_{args.dataset}_n_neighbours_{args.n_neighbors}_weights_{args.weights}_metric_{args.metric}_adjusted_{args.unadjusted}_njobs_{args.n_jobs}_batchsize_{args.batch_size}_device_{args.device}.txt'
    ...
    if not os.path.exists(output_filename) or args.force:
        ...
        #
        # print(evaluate_metrics(y_true,predictions,scorer=scorer,y_metadata=y_metadata))
        #
        #
